...
export default class Point extends mixins(JhiDataUtils) {
  ...
  public prepareRemove(instance: IPoint): void {
  ...
  public removePoint(): void {
    this.pointService()
      ...
      .then(() => {
        const message = this.$t('jhipsterVueApp.point.deleted', { param: this.removeId });
